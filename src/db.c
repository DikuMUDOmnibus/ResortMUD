...
/* Ntanel - Codebase version ID */
   ch_printf_color( ch, "&wVersion ID:  &WMudWorld ResortMUD 4.1 Revision 4\r\n" );
...
/*  towizfile( " Masters of the Realms of Despair!" );*/
   ...
   for( wiz = first_wiz; wiz; wiz = wiz->next )
   {
      if( wiz->level < ilevel )
      {
         ...
         {
            case MAX_LEVEL - 0:
               towizfile( "   &ROmnipotent &w(Level 116) &ROwner&W" );
               break;
            case MAX_LEVEL - 1:
               towizfile( "   &RSupreme Entity &w(Level 115) &RHead Implementors&W" );
               break;
            case MAX_LEVEL - 2:
               towizfile( "   &RInfinite &w(Level 114) &RImplementors&W" );
               break;
            case MAX_LEVEL - 3:
               towizfile( "   &REternal &w(Level 113) &RAssistant Implementors&W" );
               break;
            case MAX_LEVEL - 4:
               towizfile( "   &RAncient &w(Level 112) &RAdministrators&W" );
               break;
            case MAX_LEVEL - 5:
               towizfile( "   &cExalted &w(Level 111) &cCoders&W" );
               break;
            case MAX_LEVEL - 6:
               towizfile( "   &cAscendant &w(Level 110) &cRepresentatives&W" );
               break;
            case MAX_LEVEL - 7:
               towizfile( "   &cMaster Gods &w(Level 109) &cMaster Builders&W" );
               break;
            case MAX_LEVEL - 8:
               towizfile( "   &cGreater Gods &w(Level 108) &cGreater Builders&W" );
               break;
            case MAX_LEVEL - 9:
               towizfile( "   &cGods &w(Level 107) &cBuilders&W" );
               break;
            case MAX_LEVEL - 10:
               towizfile( "   &cLesser Gods &w(Level 106) &cLesser Builders&W" );
               break;
            case MAX_LEVEL - 11:
               towizfile( "   &cNew Gods &w(Level 105) &cNew Builders&W" );
               break;
            case MAX_LEVEL - 12:
               towizfile( "   &cSaviors &w(Level 104) &cGeneral Staff&W" );
               break;
            case MAX_LEVEL - 13:
               towizfile( "   &BCreators &w(Level 103) &BImmortal Family&W" );
               break;
            case MAX_LEVEL - 14:
               towizfile( "   &BAcolytes &w(Level 102) &BInter-MUD Guest&W" );
               break;
            case MAX_LEVEL - 15:
               towizfile( "   &BNeophytes &w(Level 101) &BAmbassador&W" );
               break;
            case MAX_LEVEL - 16:
               towizfile( "   &BRetired&W" );
               break;
            case MAX_LEVEL - 17:
               towizfile( "   &BGuests&W" );
               break;
            default:
               towizfile( "   &BServants&W" );
               break;
         }
      }
   ...
   for( ;; )
   {
      ...
      switch ( UPPER( word[0] ) )
      {
         ...
         case 'C':
            ...
            KEY( "Commands", sys->ccount, fread_number( fp ) );
            break;
...
/* Scion arenacode */
         ...
         case 'S':
            KEY( "Socials", sys->scount, fread_number( fp ) );
