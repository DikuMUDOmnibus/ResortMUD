...
#include <winsock.h>
#include <sys/types.h>
#pragma warning( disable: 4018 4244 4761 4996 )
#define index strchr
...
/* Academy eq */
#define OBJ_VNUM_SCHOOL_MACE	     44
#define OBJ_VNUM_SCHOOL_DAGGER	     45
#define OBJ_VNUM_SCHOOL_SWORD	     46
#define OBJ_VNUM_SCHOOL_VEST	     47
#define OBJ_VNUM_SCHOOL_SHIELD	     48
#define OBJ_VNUM_SCHOOL_BANNER	     49
...
typedef enum
{
   ...
   PLR_AUTOGOLD, PLR_AVAILABLE_FLAG, PLR_AFK, PLR_INVISPROMPT, PLR_MARRIED, PLR_NOMENU
} player_flags;
...
struct system_data
{
   ...
   short staff_level;  /* Level of staff channel */
   ...
   int mplimit;   /* Multiple player connection limit  */
   int pklimit;   /* Player killer connection limit  */
};
