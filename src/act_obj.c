...
*/
            ...
            if( IS_OBJ_STAT( container, ITEM_CLANCORPSE ) && !IS_NPC( ch ) /*&& IS_SET( ch->pcdata->flags, PCFLAG_DEADLY ) */
                && container->value[4] - ch->level < 10 && container->value[4] - ch->level > -10 )
               break;
...
void do_auction( CHAR_DATA * ch, char *argument )
{
   ...
   if( !str_cmp( arg1, "bid" ) )
   {
      goto bidding;  /* Its old, and it works perfectly. Dont diss it.--Fellon */
   }
